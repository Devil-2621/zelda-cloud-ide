                ...
                return (
                  ...
                  >
                    <AccordionTrigger
                      ...
                      className="text-left py-6 text-base font-medium hover:no-underline hover:text-primary transition-colors duration-200 [&>svg]:text-primary/50 [&>svg]:shrink-0"
                    >
                      {item.question}
                    </AccordionTrigger>
                    <AccordionContent
                      ...
                      className="text-muted-foreground pb-6 text-sm leading-relaxed"
                    >
                      {item.answer}
                    </AccordionContent>
                  </AccordionItem>
